...
export function Loading({size,color,textSize}:{size?:number, color?:string, textSize?:number}) {
...
export function Failed({size,color,textSize,text,children}:{size?:number, color?:string, textSize?:number,text:string,children:React.ReactNode}) {
